       ...
       /*step:6 adapter call*/
            ...
            public void onClick(View v) {
               ...
               /*step:4 Validating form*/
                ...
                /*step:14 collection of  data show by database*/
                    item.setWishString("Item:" + ArgentArrayList.size());
                    item.setWishString(ArgentHeadInputET.getText().toString());

                    item.setAmountInteger("Item:" + ArgentArrayList.size());
                    ...
                    Toast.makeText(getBaseContext(), "New Argent Addad to List", Toast.LENGTH_SHORT).show();
                    ...
                    if (ArgentAmountInputET.getText().toString().equals("")) {
                        ...
                        ArgentAmountInputET.setError("Argent amount can't be empty !!!");
                    }
        ...
        myArgentWishList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                helper.deleteData(argentArrayList.get(position).getWishId());
                argentArrayList.remove(position);
                adapter.notifyDataSetChanged();

                /*adapterChanged();*/
                Toast.makeText(getBaseContext(), "One Argent Item Remove", Toast.LENGTH_SHORT).show();
